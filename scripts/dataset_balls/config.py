...
config_list = {
    ...
    'shapes2d_circle_interaction': CfgNode({
        'name': 'shapes2d_circle_interaction',
        'gif_num': 5,
        'gif_fps': 5,
        'split': {
            'train': 5000,
        ...
        'options': {
            ...
            'maxnum': 3,
            'num_objs': ('random', (3, 3)),
            'obj_shapes': ('random', ('shapes2d_circle',)),
            'obj_sizes': ('random', (8.0,)),
            'obj_layers': ('random', (0,)),
            'obj_masses': ('random', (1,)),
            # See here https://htmlcolorcodes.com/
    ...
    'shapes2d_interaction_3': CfgNode({
        'name': 'shapes2d_interaction_3',
        'gif_num': 5,
        'gif_fps': 5,
        'split': {
            'train': 5000,
    ...
    'shapes2d_interaction_4': CfgNode({
        'name': 'shapes2d_interaction_4',
        'gif_num': 5,
        'gif_fps': 5,
        'split': {
            'train': 5000,
    ...
    'shapes2d_interaction_5': CfgNode({
        'name': 'shapes2d_interaction_5',
        'gif_num': 5,
        'gif_fps': 5,
        'split': {
            'train': 5000,
    ...
    'shapes2d_interaction_3-5': CfgNode({
        'name': 'shapes2d_interaction_3-5',
        'gif_num': 5,
        'gif_fps': 5,
        'split': {
            'train': 5000,
